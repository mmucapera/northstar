...
logger = logging.getLogger("gold.dim_period")
...
src_sql = '''
CREATE OR REPLACE TABLE gold.dim_period AS
SELECT DISTINCT
...
T.MonthNumber,
T.MonthName
FROM silver.period T
WHERE (T.Is_current = 1)
'''

cfg = {
    'TARGET_TABLE': 'gold.dim_period',
    'SOURCE_SQL': src_sql,
...
spark.sql(src_sql)
logger.info(f"[DIRECT] Created gold.dim_period ({spark.table('gold.dim_period').count()} rows)")
